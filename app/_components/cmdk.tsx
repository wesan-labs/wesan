...
const SEARCH_INDEX: SearchEntry[] = [
  { k: '', l: 'Home', t: ['cathedral', 'front door'], section: 'ROOF' },
  { k: 'about', l: 'About', t: ['founder', 'team', 'story', 'governance', 'yıldız'], section: 'ROOF' },
  { k: 'mission', l: 'Mission', t: ['century', 'why', 'commitments', 'patient capital'], section: 'ROOF' },
  { k: 'now', l: 'Now', t: ['this month', 'monthly', 'founder note'], section: 'ROOF' },
  { k: 'divisions', l: 'Divisions · index', t: ['three rooms', 'overview'], section: 'ROOMS' },
  { k: 'software', l: 'Software', t: ['friday', 'dante', 'notch', 'apps', 'developer'], section: 'ROOMS' },
  { k: 'studio', l: 'Studio', t: ['games', 'film', 'interactive', 'forming'], section: 'ROOMS' },
  { k: 'studio-01', l: 'Studio · Project 01', t: ['narrative game', 'anatolia', 'return'], section: 'ROOMS' },
  { k: 'studio-02', l: 'Studio · Project 02', t: ['short film', 'interactive', 'documentary'], section: 'ROOMS' },
  { k: 'industries', l: 'Industries', t: ['aerospace', 'defense', 'heavy', 'planned'], section: 'ROOMS' },
  { k: 'newsroom', l: 'Newsroom', t: ['press', 'releases', 'announcements'], section: 'BOOKS' },
  { k: 'reports', l: 'Field reports', t: ['annual', 'april', 'transparency'], section: 'BOOKS' },
  { k: 'investors', l: 'Investors', t: ['capital', 'funding', 'no investors', 'cap table'], section: 'BOOKS' },
