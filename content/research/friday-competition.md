...
- ✓ Bekircan'ın İstanbul→London geçişi narrative değerli

**Dezavantajlar:**
- ✗ 0 Twitter audience (Bekircan)
...
| 2 | **Twitter/X build-in-public** | Pieter Levels 10 yıl bu kanalla 600K audience. Friday weekly progress log Twitter'da → Hacker News'a yönlendirir. | Bekircan personal account aktif et, haftalık "Friday weekly" thread, screenshot+code+lesson. |
...
| 4 | **Indie Hackers** | Solo founder + bootstrapping topluluğu | Bekircan'ın "5 yıl self-taught, ilk venture Wesan" hikâyesi IH topluluğunda güçlü |
...
- Bekircan'ın engineering blog'unda 3 yazı: "Why daemon-first", "Rust + Tauri lessons", "How Friday uses Claude Code"
...
| Bekircan tek başına 3 ürünü yürütemez | Yüksek | Friday yavaş yetişir, momentum kaybeder | Ya Notch/Dante backburner, ya da ilk hire Friday için |
...
3. Bekircan Twitter/X aktif et — ilk thread: "Building a coding agent daemon. 30-day journey. Here's why."
